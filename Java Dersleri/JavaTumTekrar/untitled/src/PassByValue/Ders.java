...
// her iki method'u cagirdiktan sonra main method'daki list'i yazdiralim
    ...
    private static void elemanlariDegistir(List<Integer> sayilar) {
        sayilar.set(0,25);
        sayilar.set(1,54);
        sayilar.set(2,67);
        System.out.println("");
        System.out.println("Değiştirilen sayilar :" + sayilar); // [25, 54, 67]
    }
    /*
         ...
         */
    private static void yeniListAta(List<Integer>sayilar)
    {
        sayilar=new ArrayList<>();
        sayilar.add(34);
        sayilar.add(98);
        sayilar.add(11);
        System.out.println(sayilar); // [34, 98, 11]
    }
}
